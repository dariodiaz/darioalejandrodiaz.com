...
if ( ! class_exists( 'Munk_Woocommerce' ) ) :
	...
	class Munk_Woocommerce {
				...
				public function __construct() {
					...
					add_action( 'after_setup_theme', array( $this, 'munk_wc_customizer_options' ) );
					add_action( 'customize_preview_init', array( $this, 'munk_wc_customize_preview_js' ) );
				...
				public function munk_wc_customizer_options() {

						require MUNK_PARENT_INC_DIR . '/compatibility/woocommerce/customizer/woocommerce-customizer-shop.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
						require MUNK_PARENT_INC_DIR . '/compatibility/woocommerce/customizer/woocommerce-customizer-product.php';// phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
						require MUNK_PARENT_INC_DIR . '/compatibility/woocommerce/customizer/woocommerce-colors.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
				 ...
				 */
				public function munk_wc_customize_preview_js() {
					wp_enqueue_script( 'munk-wc-customizer-preview', MUNK_PARENT_INC_URI . '/compatibility/woocommerce/assets/wc_customizer_preview.js', array( 'customize-preview' ), MUNK_THEME_VERSION, true );
				}		
